...
class PromptTemplates:
    ...
    # 痛经等级提示词（0-10）- 客观描述，细化疼痛程度
    DYSMENORRHEA_TEMPLATES = {
        0: "无任何痛经症状，身体感觉正常舒适。",
        1: "下腹部有非常轻微的不适感，几乎可以忽略，不影响任何活动。",
        2: "下腹部有轻微的隐痛或胀感，能感知到但很轻微，不影响正常生活。",
        3: "下腹部有轻度的疼痛或不适，偶尔会注意到，但可以正常活动和工作。",
        4: "下腹部疼痛较为明显，时有时无，会时常注意到这种不适，但还能应对日常活动。",
        5: "下腹部持续性轻到中度疼痛，有一定的不适感，需要注意休息，但不影响基本活动。",
        6: "下腹部疼痛感较强，持续性隐痛伴随阵发性加重，影响舒适度，更想减少活动。",
        7: "下腹部明显疼痛，阵发性加重时不适感显著，活动意愿降低，需要多休息和热敷缓解。",
        8: "下腹部疼痛明显且持续，阵痛时感觉较为难受，影响日常活动，需要充分休息和照顾。",
        9: "下腹部疼痛强烈，持续的痛感伴随较强的阵痛，较难忍受，严重影响舒适度和活动能力。",
        10: "下腹部疼痛非常强烈，疼痛感显著且持续，明显影响日常生活，需要大量休息和悉心照顾。"
    }
